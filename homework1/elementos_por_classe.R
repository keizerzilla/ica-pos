...
summary(base_6_ri)
summary(base_7_ri)
#fim da compara??o de cada elemnto por diferentes classes
...
#aplicando PCA
base.pcal<- princomp(base[,1:9],scores=TRUE)
#observar desvio padr?o e a propo??o de varia??o de cada componente
summary(base.pcal)
#plotar gr?fico da propo??o de variaacao
plot(base.pcal)
